...
public class HttpFileServer {
	...
	public static void StartServer(String docRoot, int port) {
	...
	public static void main(String[] args) throws Exception {
		...
		HttpFileServer.StartServer(docRoot, port);
		System.out.println("ShutDown Server Success");
